 ...
 */
export async function chat({ model, messages, schema, schemaName = "output", tag, maxTokens = 8000, temperature = 0 }) {
  assertKey();
...
export async function vision({
  ...
  return chat({ model, messages, schema, schemaName, tag, maxTokens });
}
